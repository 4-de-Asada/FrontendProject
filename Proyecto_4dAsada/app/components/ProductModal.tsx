// Modal de detalle de producto: muestra imagen, info del vendedor, descripción y botón de contacto por WhatsApp.
"use client";
      ...
      >
        <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-xl pointer-events-auto animate-modal-in overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row">
            {/* ── Izquierda: imagen + info del vendedor ──────────────────────── */}
